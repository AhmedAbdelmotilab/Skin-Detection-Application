...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          padding:  const EdgeInsets.only(left: 48,right: 48,top: 90,bottom: 30),
          child: Column(
            ...
            children: [
              Flexible(
                ...
                child: Column(
                  ...
                  const Text("Welcome To Skin Detection App",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w500)),
                  const SizedBox(height: 10),
                  const Text("Be Safe , Be Comfortable",style: TextStyle(fontSize: 15,color: Colors.grey,fontWeight: FontWeight.w500)),
                  ],
                ),
              ),
              Column(
                  ...
                  RoundedLoadingButton(
                    ...
                    child: Wrap(
                      children: const[
                        ...
                        SizedBox(width: 15,),
                        Text("sign in with facebook",style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.w500),)
                      ],
                    ),
